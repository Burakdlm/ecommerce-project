                ...
                <form action="{{url("/users")}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Eposta giriniz" value="{{old("email")}}">
                            @error("email")
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Şifreyi Tekrar Giriniz" autocomplete="new-password">
                            @error("password")
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
